package com.javayhu.kiss.monitor.permission;
...
import com.javayhu.kiss.monitor.R;

import java.lang.reflect.Field;
import java.lang.reflect.Method;

/**
 * 悬浮窗权限管理 (适配不同机型申请悬浮窗权限)
 * https://github.com/zhaozepeng/FloatWindowPermission
 * <p>
 * Updated by hujiawei on 2017/1/22.
 * Created by zhaozp on 2016-10-17.
 */
public class FloatWindowPermission {
    ...
    private void showConfirmDialog(Context context, OnConfirmResult result) {
        showConfirmDialog(context, context.getString(R.string.permission_dialog_content), result);
    }
    ...
    private void showConfirmDialog(Context context, String message, final OnConfirmResult result) {
        ...
        dialog = new AlertDialog.Builder(context).setCancelable(true).setTitle("")
                .setMessage(message)
                .setPositiveButton(R.string.permission_now_to,
                        ...
                        }).setNegativeButton(R.string.permission_current_not,
                        new DialogInterface.OnClickListener() {
